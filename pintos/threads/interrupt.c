...
intr_get_level(void)
{
	...
	/* Push the flags register on the processor stack, then pop the
		 ...
		 Interrupts". */
	/* 프로세서 스택에 플래그 레지스터를 푸시한 다음, 스택에서 그 값을 'flags'로 팝합니다.
		[IA32-v2b] "PUSHF" 및 "POP", 그리고 [IA32-v3a] 5.8.1 "Masking Maskable Hardware Interrupts"를 참조하세요. */
...
/* 외부 인터럽트 처리 중에만 '참'을 반환하고, 다른 모든 경우에는 '거짓'을 반환합니다. */
